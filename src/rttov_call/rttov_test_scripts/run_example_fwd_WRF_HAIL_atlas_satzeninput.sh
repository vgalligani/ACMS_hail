...
COEF_FILENAME='rtcoef_noaa_19_mhs.dat'

#PROF_FILENAME='atm_em1.0rttov14_WRF-WSM6_2018-11-10_20_AMSR2.dat'   # Input profile(s), usually found in $TEST_DIR 
#PROF_FILENAME='atm_em1.0rttov14_WRF-WSM6_2018-11-10_20_AMSR2satzen_input.dat'
PROF_FILENAME='atm_rttov14_WRF-WSM6_2018-11-10_20:30_MHSsatzen_OBSinterp.dat' 
...
# Experiment naming
EXP='WRF_WSM6_20181110_20_'${SATNAME}'_atlas_satzen_input'
...
mv output_tb_{$SATNAME} ${out_folder}/.
