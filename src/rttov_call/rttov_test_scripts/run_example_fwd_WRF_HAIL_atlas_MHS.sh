...
# Input data
COEF_FILENAME='rtcoef_noaa_19_mhs.dat'                              # Location of this file is set below in $COEF_DIR
PROF_FILENAME='atm_em1.0rttov14_WRF-WSM6_2018-11-10_20_MHS.dat'     # Input profile(s), usually found in $TEST_DIR 

# Insstrument info
NCHAN=5                           # Number of channels to simulate for each profile
CHAN_LIST=$(seq -s ' ' $NCHAN)     # Space-separated channel-list
#ZENITH=45 ZENITH IS NOW INSIDE PROF_FILENAME AS FOR MHS THIS VARIES ... 

# Experiment naming
EXP='WRF_WSM6_20181110_20_MHS_atlas'

#----------------------------------------------------#
# Main rttov dir
#rttov_main_dir="/home/vito.galligani/Work/Studies/HAILCASE_10112018/rttov14.0_beta"
rttov_main_dir="/home/vito.galligani/datosmunin3/Work/Studies/HAILCASE_10112018/rttov14.0_beta"
...
TEST_DIR=./../../../../../HAILCASE_10112018_datos/RTTOVout/InputAll/
