...
!     CALL rttov_skipcommentline(iup, errorstatus)
  ...
  OPEN(ioout, file='output_tb_'//trim(fout1), status='unknown', form='formatted', iostat=ios)      ! Vito
  IF (ios /= 0) THEN                                                                 ! Vito
  ...
  OPEN(21,   file='surface2space_transm_'//trim(fout1), status='unknown', form='formatted', iostat=ios)      ! V
  DO iprof = 1, nprof                                                                          ! V
  ...
  OPEN(ioout, file='output_transm_'//trim(fout1), status='unknown', form='formatted', iostat=ios)            ! Vito
