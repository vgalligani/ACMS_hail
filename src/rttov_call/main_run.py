...
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
def main(EXP, makeProfs, instrument, HHtime): 
    ...
    if makeProfs == 1: 
        ...
        run_IFS_rttov14(ipnd=1, mp_version=6, HHtime=HHtime, sensor_config=instrument, Flagged_Profs=skipProfs)
        ...
        ncfile     = ncfolder+'wrfout_d02_2018-11-10_'+HHtime+':00:00'
...
def make_plots(EXP): 
    ...
    main(EXP=EXP, makeProfs=0, instrument='AMSR2', HHtime='20')  
...
def make_profs(EXP):
    ...
    main(EXP=EXP2, makeProfs=1, instrument='AMSR2', HHtime='20')  
