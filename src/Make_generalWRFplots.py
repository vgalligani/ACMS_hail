...
#------------------------------------------------------------------------------
def plot_ZH1km_WRF_wWRF_shelicity(EXP, title):
...
#------------------------------------------------------------------------------
def plot_ZH1km_WRF_wWRF_uhelicity_only(EXP, title):
...
#------------------------------------------------------------------------------
def plot_ZH1km_WRF_wWRFwind(EXP, title):
    ...
    ax.text(x=-65, y=-34.9, s='120 and 220 km radar rings')
    #plt.show()
    fig.savefig(save_dir_compare+'/'+EXP+'/winds/WRF_ZH1km_general_evolution_'+title+'10mwind.png', dpi=300,transparent=False,bbox_inches='tight')
    plt.close()
    ...
    ax.text(x=-65, y=-34.9, s='120 and 220 km radar rings')
    #plt.show()
    fig.savefig(save_dir_compare+'/'+EXP+'/convergence/WRF_ZH1km_general_evolution_'+title+'WRFvars_moistureconvergence_simpler.png', dpi=300,transparent=False,bbox_inches='tight')
    plt.close()
...
def run_all(): 
    ...
    for EXP in EXPs:
        for h in range(18, 22):
            for m in range(0, 60, 30):
                plot_ZH1km_WRF_wWRFwind(EXP, f"{h}:{m:02d}")
